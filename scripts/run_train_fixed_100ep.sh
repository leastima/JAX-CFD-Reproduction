...
OUTPUT_DIR="$STORAGE_PATH/model_fixed_100ep"    # 100 epoch run
...
export CUDA_VISIBLE_DEVICES=5  # 100ep
...
python -u models/train.py \
  ...
  2>&1 | tee "$LOG_DIR/train_fixed_100ep.txt"
