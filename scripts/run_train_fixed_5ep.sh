...
OUTPUT_DIR="$STORAGE_PATH/model_fixed_10ep"     # 10 epoch run
...
export CUDA_VISIBLE_DEVICES=6  # 10ep
...
python -u models/train.py \
  ...
  2>&1 | tee "$LOG_DIR/train_fixed_10ep.txt"
